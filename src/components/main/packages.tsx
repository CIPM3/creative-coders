...
const PackagesSection = () => {
    ...
    return (
        <section id='paquetes' className="w-full packages-section min-h-screen bg-creative_secondary px-[7dvw] pb-16">
            <div className="w-full flex justify-center pt-[5%]">
                <h2 className="text-white text-6xl font-bold">Nuestros paquetes</h2>
            </div>
